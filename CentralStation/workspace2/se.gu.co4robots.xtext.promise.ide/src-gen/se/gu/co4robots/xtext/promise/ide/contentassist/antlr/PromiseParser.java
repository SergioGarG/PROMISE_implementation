		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMissionAccess().getGroup_2_2_3(), "rule__Mission__Group_2_2_3__0");
					put(grammarAccess.getMissionAccess().getGroup_2_3(), "rule__Mission__Group_2_3__0");
					put(grammarAccess.getMissionAccess().getGroup_2_3_3(), "rule__Mission__Group_2_3_3__0");
					...
					put(grammarAccess.getMissionAccess().getGroup_8_3(), "rule__Mission__Group_8_3__0");
					put(grammarAccess.getMissionAccess().getGroup_9(), "rule__Mission__Group_9__0");
					put(grammarAccess.getMissionAccess().getGroup_9_4(), "rule__Mission__Group_9_4__0");
					put(grammarAccess.getMissionAccess().getGroup_14(), "rule__Mission__Group_14__0");
					...
					put(grammarAccess.getDelegateOpAccess().getGroup_7(), "rule__DelegateOp__Group_7__0");
					put(grammarAccess.getDelegateOpAccess().getGroup_7_2(), "rule__DelegateOp__Group_7_2__0");
					put(grammarAccess.getDelegateOpAccess().getGroup_8(), "rule__DelegateOp__Group_8__0");
					put(grammarAccess.getDelegateOpAccess().getGroup_8_2(), "rule__DelegateOp__Group_8_2__0");
					...
					put(grammarAccess.getMissionAccess().getConditionsAssignment_2_2_2(), "rule__Mission__ConditionsAssignment_2_2_2");
					put(grammarAccess.getMissionAccess().getConditionsAssignment_2_2_3_1(), "rule__Mission__ConditionsAssignment_2_2_3_1");
					put(grammarAccess.getMissionAccess().getConditionsAssignment_2_3_2(), "rule__Mission__ConditionsAssignment_2_3_2");
					put(grammarAccess.getMissionAccess().getConditionsAssignment_2_3_3_1(), "rule__Mission__ConditionsAssignment_2_3_3_1");
					...
					put(grammarAccess.getMissionAccess().getLocationAssignment_8_2(), "rule__Mission__LocationAssignment_8_2");
					put(grammarAccess.getMissionAccess().getLocationAssignment_8_3_1(), "rule__Mission__LocationAssignment_8_3_1");
					put(grammarAccess.getMissionAccess().getLocationAssignment_9_3(), "rule__Mission__LocationAssignment_9_3");
					put(grammarAccess.getMissionAccess().getLocationAssignment_9_4_1(), "rule__Mission__LocationAssignment_9_4_1");
					put(grammarAccess.getMissionAccess().getOperatorAssignment_13(), "rule__Mission__OperatorAssignment_13");
					put(grammarAccess.getMissionAccess().getOperatorAssignment_14_1(), "rule__Mission__OperatorAssignment_14_1");
					put(grammarAccess.getRobotAccess().getNameAssignment(), "rule__Robot__NameAssignment");
					put(grammarAccess.getOrderedLocationAccess().getNameAssignment(), "rule__OrderedLocation__NameAssignment");
					put(grammarAccess.getNotOrderedLocationAccess().getNameAssignment(), "rule__NotOrderedLocation__NameAssignment");
					...
					put(grammarAccess.getDelegateOpAccess().getInputRobotAssignment_3(), "rule__DelegateOp__InputRobotAssignment_3");
					put(grammarAccess.getDelegateOpAccess().getInputRobotAssignment_4_1(), "rule__DelegateOp__InputRobotAssignment_4_1");
					put(grammarAccess.getDelegateOpAccess().getPatternAssignment_6(), "rule__DelegateOp__PatternAssignment_6");
					put(grammarAccess.getDelegateOpAccess().getInputLocationsAssignment_7_1(), "rule__DelegateOp__InputLocationsAssignment_7_1");
					put(grammarAccess.getDelegateOpAccess().getInputLocationsAssignment_7_2_1(), "rule__DelegateOp__InputLocationsAssignment_7_2_1");
					put(grammarAccess.getDelegateOpAccess().getInputActionAssignment_8_1(), "rule__DelegateOp__InputActionAssignment_8_1");
