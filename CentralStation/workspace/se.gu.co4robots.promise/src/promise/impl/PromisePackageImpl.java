...
public class PromisePackageImpl extends EPackageImpl implements PromisePackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getCompositionOperator_InputOperators(), this.getOperator(), null, "inputOperators", null, 1, -1, CompositionOperator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
