		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMissionAccess().getGroup_6_3(), "rule__Mission__Group_6_3__0");
					...
					put(grammarAccess.getMissionAccess().getEventsAssignment_2_2_2(), "rule__Mission__EventsAssignment_2_2_2");
					put(grammarAccess.getMissionAccess().getEventsAssignment_2_2_3_1(), "rule__Mission__EventsAssignment_2_2_3_1");
					put(grammarAccess.getMissionAccess().getActionsAssignment_2_3_2(), "rule__Mission__ActionsAssignment_2_3_2");
					put(grammarAccess.getMissionAccess().getActionsAssignment_2_3_3_1(), "rule__Mission__ActionsAssignment_2_3_3_1");
					...
					put(grammarAccess.getMissionAccess().getLocationsAssignment_6_2(), "rule__Mission__LocationsAssignment_6_2");
					put(grammarAccess.getMissionAccess().getLocationsAssignment_6_3_1(), "rule__Mission__LocationsAssignment_6_3_1");
